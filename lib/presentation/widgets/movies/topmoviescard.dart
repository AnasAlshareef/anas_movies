    ...
    return Container(
      ...
      child: Column(
        children: [
          InkWell(
            onTap: (){
              Navigator.of(context).pushNamed('topDetails',arguments: widget.toprated);
            },
            onLongPress: () {
              setState(() {
                isvisibale = true;
              ...
              child: Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.network(
                      'https://image.tmdb.org/t/p/w500${widget.toprated!.posterPath}',
                      width: 210,
                      height: 300,
                      fit: BoxFit.cover,
                    ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                "${widget.toprated!.title} (${widget.toprated!.releaseDate})",
                            ...
                            IconButton(
                              onPressed: (){
                                ...
                                if(isPressd==true){
                                  BlocProvider.of<FavoritesCubit>(context).addFavorite(widget.toprated!.id!,"movie",true);
                                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content:Text("Movie Added to Favorite!")));


                                }if(isPressd==false){
                                  BlocProvider.of<FavoritesCubit>(context).addFavorite(widget.toprated!.id!,"movie",false);
